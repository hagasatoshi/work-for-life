...
(function($) {
  ...
  function makeupBalloon($target, $balloon, options) {
    ...
    var initTipStyle = {position: 'absolute', height: '0', width: '0', border: 'solid 0 transparent'},
  ...
  $.fn.balloon = function(options) {
    return this.one('mouseenter', function first(e) {
      ...
      var $balloon = $target.on('mouseenter', function(e) {
  ...
  $.fn.showBalloon = function(options) {
    ...
    return this.each(function() {
      ...
      var contents = $.isFunction(options.contents) ? options.contents.apply(this)
  ...
  $.fn.hideBalloon = function() {
    ...
    return this.each(function() {
      var $target = $(this), $balloon = $target.data('balloon');
